      ...
      <div className="px-3 py-4 border-t border-sidebar-border flex flex-col gap-1">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-sidebar-accent">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-sidebar-foreground truncate">Ana Sofía Torres</p>
            <p className="text-[10px] text-sidebar-foreground/50 truncate">Verificado ✓</p>
          </div>
        </div>
        <Link
          href="/login"
