...
function CategoryIcon({ category }: { category: AdminNotificationCategory }) {
  const meta = ADMIN_CATEGORY_META[category];
...
export function AdminNotificationItem({
  ...
  const meta = ADMIN_CATEGORY_META[notification.category];
  const isUnread = !notification.read;
  const isHighPriority = notification.priority === "high" && isUnread;
