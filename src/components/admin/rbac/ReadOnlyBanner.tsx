...
export function ReadOnlyBanner({ module }: ReadOnlyBannerProps) {
  ...
  return (
    <div className="mb-6 flex items-start gap-3 rounded-2xl border border-info/20 bg-info/10 px-4 py-3.5">
      <div className="size-9 rounded-xl bg-info/15 flex items-center justify-center shrink-0">
        <Eye className="size-4 text-info" />
      </div>
      <div>
        <p className="text-sm font-semibold text-info">Modo solo lectura</p>
        <p className="text-xs text-info/80 mt-0.5 leading-relaxed">
