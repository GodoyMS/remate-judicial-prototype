    ...
    >
      {hasVideo && (
        <button
          ...
          className="absolute -right-2 -top-2 z-10 flex items-center gap-1 rounded-full border border-primary/40 bg-foreground px-2.5 py-1 text-[10px] font-semibold text-primary shadow-md transition-transform hover:scale-105"
        >
      ...
      <p className="line-clamp-4 flex-1 text-sm leading-relaxed text-foreground/80">
      ...
      {hasVideo && (
        <button
          type="button"
          onClick={() => onOpen(testimonial)}
          className="relative overflow-hidden rounded-xl bg-gradient-to-br from-foreground to-foreground/80 p-4 text-left transition-transform hover:scale-[1.02]"
        >
          ...
          <div className="relative flex items-center gap-3">
            <span className="flex size-10 items-center justify-center rounded-full bg-primary shadow-lg shadow-primary/30">
      ...
      <div className="flex items-center gap-3 border-t border-foreground/8 pt-4">
        ...
        {testimonial.amount && (
          <span className="hidden shrink-0 rounded-full bg-primary/25 px-2.5 py-1 text-[10px] font-semibold text-primary sm:inline">
            {testimonial.amount}
          </span>
        )}
      </div>
